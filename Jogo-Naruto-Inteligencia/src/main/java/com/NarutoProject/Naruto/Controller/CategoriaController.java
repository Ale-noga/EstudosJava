...
public class CategoriaController {
	...
	public ResponseEntity<Categoria> getByNome(@PathVariable String posicao) {
		return repository.findAllByPosicaoContainingIgnoreCase(posicao).map(resp -> ResponseEntity.ok(resp))
